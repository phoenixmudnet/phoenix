...
#ifdef BUILDERS_PORT		// BUILDERS PORT
const struct command_info cmd_info[] = {
	...
	{"backup", POS_DEAD, do_backup, LVL_IMMORT, 0},
...
/*      { "draw"     , POS_STANDING, do_draw     , 0, 0 } , */
	...
	{"endreply ", POS_DEAD, do_end_discussion, LVL_IMMORT, 0},
	...
	{"idle", POS_DEAD, do_idle, LVL_IMMORT, 0},
	{"iforce", POS_SLEEPING, do_force, LVL_SIMP, SCMD_IFORCE},
	{"igive", POS_DEAD, do_igive, LVL_GOD, 0},
	...
	{"itake", POS_DEAD, do_itake, LVL_GOD, 0},
	...
	{"logsearch", POS_DEAD, do_logsearch, LVL_IMMORT, SCMD_LOGSEARCH},
	...
	{"mlev", POS_DEAD, do_mlev, LVL_IMMORT, 0},
	{"mlist", POS_DEAD, do_mlist, LVL_IMMORT, 0},
	{"mount", POS_STANDING, do_mount, 0, 0},
	{"mortalize", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_MORTAL},
	...
	{"olc", POS_DEAD, do_olc, LVL_IMMORT, SCMD_OLC_SAVEINFO},
	...
	{"plink", POS_SLEEPING, do_plink, LVL_IMMORT, 0},
	...
	/*{ "project"  , POS_DEAD    , do_project  , LVL_IMMORT, 0}, */
	...
	{"recharge", POS_STANDING, do_recharge, LVL_IMMORT, 0},
	...
	{"remorts", POS_DEAD, check_invalid_remorts, LVL_IMMORT, 0},
	...
	{"redit", POS_DEAD, do_olc, LVL_IMMORT, SCMD_OLC_REDIT},
	...
	{"smite", POS_SLEEPING, do_smite, LVL_IMMORT, 0},
	{"sneak", POS_STANDING, do_sneak, 1, 0},
	{"snoop", POS_DEAD, do_snoop, LVL_DGOD, SCMD_SNOOP},
	...
	{"tcheck", POS_DEAD, do_tcheck, LVL_IMMORT, 0},
	{"teams", POS_SLEEPING, do_gen_ps, 0, SCMD_TEAMS},
	{"tedit", POS_DEAD, do_tedit, LVL_GRGODI, 0},
	{"teleport", POS_DEAD, do_teleport, LVL_IMMORT, 0},
	...
	{"vban", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_BAN},
	{"vbigrent", POS_DEAD, do_gen_vfile, LVL_DGOD, SCMD_V_BIGRENT},
	{"vbuf", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_BUF},
	{"vbugs", POS_DEAD, do_gen_vfile, LVL_DETY, SCMD_V_BUGS},
	{"vchanges", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_CHANGES},
	{"vcorpse", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_CORPSE},
	{"vcrash", POS_DEAD, do_gen_vfile, LVL_GRGOD, SCMD_V_CRASH},
	{"vdeath", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_DEATH},
	{"vdeleted", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_DELETE},
	{"verrors", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_ERRORS},
	{"vgodcmd", POS_DEAD, do_gen_vfile, LVL_ADMIN, SCMD_V_GODCMD},
	{"vgold", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_GOLD},
	{"vgodfight", POS_DEAD, do_gen_vfile, LVL_GOD, SCMD_V_GODFIGHT},
	{"vhelp", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_HELP},
	{"videas", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_IDEAS},
	{"viewlog", POS_DEAD, do_logsearch, LVL_IMMORT, SCMD_VIEWLOG},
	{"vlastcmd", POS_DEAD, do_gen_vfile, LVL_ADMIN, SCMD_V_LASTCMD},
	{"vlevels", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_LEVELS},
	...
	{"vnew", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_NEWPLAYERS},
	{"vobjscrap", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_OBJSCRAP},
	{"volc", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_OLC},
	{"vrentgone", POS_DEAD, do_gen_vfile, LVL_ADMIN, SCMD_V_RENTGONE},
	{"vrestarts", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_RESTARTS},
	{"vrip", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_RIP},
	{"vscripterr", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_SCRIPTERR},
	{"vscriptlog", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_SCRIPTLOG},
	...
	{"vtypos", POS_DEAD, do_gen_vfile, LVL_IMMORT, SCMD_V_TYPOS},
	...
	{"zedit", POS_DEAD, do_olc, LVL_IMMORT, SCMD_OLC_ZEDIT},
	{"zinfo", POS_DEAD, do_zinfo, 1, 0},
	{"zlist", POS_DEAD, do_zlist, LVL_IMMORT, 0},
