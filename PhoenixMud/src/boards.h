...
#define MAX_BOARD_MESSAGES 	180     /* arbitrary -- change if needed */
...
struct board_info_type {
   ...
   int  clan_num;       /* the number of the clan that owns this board */
};
...
#define BOARD_CLAN(i) (board_info[i].clan_num)
