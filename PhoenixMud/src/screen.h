...
#define NNRM CCNRM(ch,C_NRM)
#define NRED CCRED(ch,C_NRM)
#define NGRN CCGRN(ch,C_NRM)
#define NYEL CCYEL(ch,C_NRM)
#define NBLU CCBLU(ch,C_NRM)
#define NMAG CCMAG(ch,C_NRM)
#define NCYN CCCYN(ch,C_NRM)
#define NWHT CCWHT(ch,C_NRM)
