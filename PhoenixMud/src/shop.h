...
struct shop_data {
   ...
   mob_rnum keeper;		/* The mobil who owns the shop (virtual)*/
   ...
   int   top_order;		/* Auto extract order top               */
...
#define IS_GOD(ch)		(!IS_NPC(ch) && (GET_LEVEL(ch) >= LVL_DGOD))
...
#define TRADE_NOBARD            (1 << 8)
#define TRADE_NOMONK            (1 << 9)
#define TRADE_NOUNUSED          (1 << 10)
#define TRADE_NOBARBARIAN       (1 << 11)
#define TRADE_NOPALADIN         (1 << 12)
#define TRADE_NOAPALADIN        (1 << 13)
#define TRADE_NODRUID           (1 << 14)
#define TRADE_NOMERCHANT        (1 << 15)
#define TRADE_NOKENSAI          (1 << 16)
#define TRADE_NOASSASSIN        (1 << 17)
#define TRADE_NONECRO           (1 << 18)
#define TRADE_NODEVA            (1 << 19)
#define TRADE_NOIMMORTAL        (1 << 20)
#define TRADE_NOGOD             (1 << 21)
#define TRADE_NONONECLASS       (1 << 22)
...
#define SHOP_TOP_ORDER(i)	(shop_index[(i)].top_order)
...
#define NOTRADE_UNUSED(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOUNUSED))
...
#define NOTRADE_APALADIN(i)  (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOAPALADIN))
...
#define NOTRADE_KENSAI(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOKENSAI))
#define NOTRADE_ASSASSIN(i)  (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOASSASSIN))
#define NOTRADE_NECRO(i)     (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NONECRO))
#define NOTRADE_DEVA(i)      (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NODEVA))
#define NOTRADE_IMMORTAL(i)  (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOIMMORTAL))
#define NOTRADE_GOD(i)       (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOGOD))
#define NOTRADE_NONECLASS(i) (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NONONECLASS))

#define	WILL_START_FIGHT	(1 << 0)
#define WILL_BANK_MONEY		(1 << 1)
#define WILL_JUNK_ITEMS		(1 << 2)
...
#define SHOP_JUNK_ITEM(i)	(IS_SET(SHOP_BITVECTOR(i), WILL_JUNK_ITEMS))

#define MIN_OUTSIDE_BANK	2000
#define MAX_OUTSIDE_BANK	5000
